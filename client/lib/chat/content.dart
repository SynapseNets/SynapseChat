...
class MessageRetriever with ChangeNotifier {
  retrieve(List<Message> list, String sender) {
    retrieveMessage(sender).then((value) {
      list = value;
      print(list.toString());
      notifyListeners();
    });
...
class _ContentState extends State<Content> {
  ...
  final MessageRetriever retriever = MessageRetriever();

  List<Message> messages = List.empty();

  @override
  Widget build(BuildContext context) {
    retriever.retrieve(messages, 'me');

    return Stack(children: [
      ListenableBuilder(
          listenable: retriever,
                ...
                switch (message.type) {
                  ...
                  case MessageType.audio:
                    return BubbleNormalAudio(
                      ...
                      position:
                          position.inSeconds.toDouble(), //TODO: same as above
                      onSeekChanged: (value) {
                        setState(() {
